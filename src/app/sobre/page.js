    ...
    <main className="min-h-screen px-8 py-16 max-w-4xl mx-auto">
      ...
      <section className="max-w-2xl space-y-6">
        <p className="text-nier-bege/70 tracking-wider leading-relaxed text-sm">
          olá, sou Glauber Mendel, desenvolvedor fullstack web/mobile em transição de carreira. 
        ...
        <p className="text-nier-beige/70 tracking-wider leading-relaxed text-sm">
          Atualmente construindo aplicações com React, Next.js e Node.js. 
          Tenho projetos em mente para contribuir com a comunidade neurodivergente, 
